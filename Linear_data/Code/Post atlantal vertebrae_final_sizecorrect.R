...
PoAtVerts <-  Amb_linear_data[c(6:7, 14:48,50, 54:55)] #select only relevant Post atlantal measurements
...
T1 <- dplyr::select(PoAtVerts_wofossil, contains("a", ignore.case = FALSE), contains("SVL_P"), contains("species")) %>% drop_na()


T4 <- dplyr::select(PoAtVerts_wofossil, contains("b", ignore.case = FALSE),contains("SVL_P"), contains("species")) %>% drop_na()

T8 <- dplyr::select(PoAtVerts_wofossil, contains("c", ignore.case = FALSE), contains("SVL_P"),contains("species")) %>% drop_na()
T8 <- subset(T8, select=-c(specimen_num))

T8_extension <- dplyr::select(PoAtVerts_wofossil, contains("Cen"),contains("SVL_P"), contains("species")) %>% drop_na()

T12<- dplyr::select(PoAtVerts_wofossil, contains("d", ignore.case = FALSE),contains("SVL_P"), contains("species")) %>% drop_na()

Sc <- dplyr::select(PoAtVerts_wofossil, num_range("X", 14:20),contains("SVL_P"), contains("species")) %>% drop_na()
...
T1 <- data.frame(as.data.frame(t(apply(T1[,1:7], 1, Shape.varb.calc))), species = T1$species)
T4 <- data.frame(as.data.frame(t(apply(T4[,1:7], 1, Shape.varb.calc))), species = T4$species)
T8 <- data.frame(as.data.frame(t(apply(T8[,1:7], 1, Shape.varb.calc))), species = T8$species)
T12 <- data.frame(as.data.frame(t(apply(T12[,1:7], 1, Shape.varb.calc))), species = T12$species)
...
t <-round(t, digits = 2)
write.table(t, file = "size corrected T1 species KNNAC", sep = ",", quote = FALSE, row.names = T)
...
t <-round(t, digits = 2)
write.table(t, file = "size corrected T8 species KNNAC", sep = ",", quote = FALSE, row.names = T)
...
t <-round(t, digits = 2)
write.table(t, file = "size corrected T12 species KNNAC", sep = ",", quote = FALSE, row.names = T)
...
t <- rf_acc_ant
t <-round(t, digits = 2)
write.table(t, file = "size corrected Anterior verts RFAC species", sep = ",", quote = FALSE, row.names = T)
...
t <- rf_acc_T8
t <-round(t, digits = 2)
write.table(t, file = "size corrected T8 RFAC species", sep = ",", quote = FALSE, row.names = T)
...
t <- rf_acc_T12
t <-round(t, digits = 2)
write.table(t, file = "size corrected T12 RFAC species", sep = ",", quote = FALSE, row.names = T)
...
t <-round(t, digits = 2)
write.table(t, file = "size corrected T8 clades KNNAC", sep = ",", quote = FALSE, row.names = T)
...
predicted.classes_T12clades <- train(clades ~ X7d + X8d + X9d + X10d + X11d + X12d + X13d,
                                     method     = "knn",
                                     tuneGrid   = expand.grid(k = kfishT12clades),
                                     trControl  = trainControl(method  = "LOOCV"),
                                     metric     = "Accuracy",
                                     data       = Trunk12_sub)$pred # predict class based on KNN model
...
t <-round(t, digits = 2)
write.table(t, file = "size corrected T12 clades KNNAC", sep = ",", quote = FALSE, row.names = T)
...
t <- rf_acc_T8clades
t <-round(t, digits = 2)
write.table(t, file = "size corrected T8 RFAC clades", sep = ",", quote = FALSE, row.names = T)
...
t <- rf_acc_T12clades
t <-round(t, digits = 2)
write.table(t, file = "size corrected T12 RFAC clades", sep = ",", quote = FALSE, row.names = T)
...
TrunkFossilAnt <- data.frame(as.data.frame(t(apply(TrunkFossilAnt[,1:7], 1, Shape.varb.calc))), species = TrunkFossilAnt$species)
TrunkFossilT8 <- data.frame(as.data.frame(t(apply(TrunkFossilT8[,1:7], 1, Shape.varb.calc))), species = TrunkFossilT8$species)
TrunkFossilT12 <- data.frame(as.data.frame(t(apply(TrunkFossilT12[,1:7], 1, Shape.varb.calc))), species = TrunkFossilT12$species)
TrunkFossilSc <- data.frame(as.data.frame(t(apply(TrunkFossilSc[,1:7], 1, Shape.varb.calc))), species = TrunkFossilSc$species)
...
t <-round(t, digits = 2)
write.table(t, file = "size corrected Sacral species KNNAC", sep = ",", quote = FALSE, row.names = T)
...
runs <- 100
system.time({
  fishpost <- foreach(icount(runs)) %dopar% {
...
predicted.classes_post <- train(species ~ X1a + X2a + X3a + X4a + X5a + X6a + X7a,
                                method     = "knn",
                                tuneGrid   = expand.grid(k = kfishpost),
                                trControl  = trainControl(method  = "LOOCV"),
                                metric     = "Accuracy",
...
t <-round(t, digits = 2)
write.table(t, file = "size corrected Posterior trunk linear species KNNAC", sep = ",", quote = FALSE, row.names = T)
...
runs <- 100
system.time({
  fishmid <- foreach(icount(runs)) %dopar% {
    train(species ~ X1a + X2a + X3a + X4a + X5a + X6a + X7a,
          method     = "knn",
          tuneGrid   = expand.grid(k = 1:17),
          trControl  = trainControl(method  = "LOOCV"),
...
predicted.classes_mid <- train(species ~ X1a + X2a + X3a + X4a + X5a + X6a + X7a,
                               method     = "knn",
                               tuneGrid   = expand.grid(k = kfishmid),
                               trControl  = trainControl(method  = "LOOCV"),
                               metric     = "Accuracy",
...
t <-round(t, digits = 2)
write.table(t, file = "size corrected Middle trunk linear species KNNAC", sep = ",", quote = FALSE, row.names = T)
...
runs <- 100
system.time({
  fishant <- foreach(icount(runs)) %dopar% {
    train(species ~ X1a + X2a + X3a + X4a + X5a + X6a + X7a,
          method     = "knn",
          tuneGrid   = expand.grid(k = 1:17),
          trControl  = trainControl(method  = "LOOCV"),
...
predicted.classes_ant <- train(species ~ X1a + X2a + X3a + X4a + X5a + X6a + X7a,
                               method     = "knn",
                               tuneGrid   = expand.grid(k = kfishant),
                               trControl  = trainControl(method  = "LOOCV"),
                               metric     = "Accuracy",
                               data       = TrunkAnt_sub)$pred # predict class based on KNN model
...
t <-round(t, digits = 2)
write.table(t, file = "size corrected Anterior verts linear species KNNAC", sep = ",", quote = FALSE, row.names = T)
...
runs <- 100
system.time({
  fishScclade <- foreach(icount(runs)) %dopar% {
...
predicted.classes_sc_clade <- train(clades ~ X14 + X15 + X16 + X17 + X18 + X19 + X20,
                                    method     = "knn",
                                    tuneGrid   = expand.grid(k = kfishScclade),
                                    trControl  = trainControl(method  = "LOOCV"),
                                    metric     = "Accuracy",
                                    data       = TrunkSc_sub)$pred # predict class based on KNN model
...
t <-round(t, digits = 2)
write.table(t, file = "size corrected Sacral clade KNNAC", sep = ",", quote = FALSE, row.names = T)
...
predicted.classes_post_clade <- train(clades ~ X1a + X2a + X3a + X4a + X5a + X6a + X7a,
                                      method     = "knn",
                                      tuneGrid   = expand.grid(k = kfishpostCLADE),
                                      trControl  = trainControl(method  = "LOOCV"),
                                      metric     = "Accuracy",
                                      data       = TrunkPost_sub)$pred # predict class based on KNN model
...
t <-round(t, digits = 2)
write.table(t, file = "size corrected posterior trunk clade KNNAC", sep = ",", quote = FALSE, row.names = T)
...
runs <- 100
system.time({
  fishmidCLADE <- foreach(icount(runs)) %dopar% {
    train(clades ~ X1a + X2a + X3a + X4a + X5a + X6a + X7a,
          method     = "knn",
          tuneGrid   = expand.grid(k = 1:17),
          trControl  = trainControl(method  = "LOOCV"),
...
fishmidCLADE <- map_dfr(fishmidCLADE,`[`, c("k", "Accuracy", "Kappa"))
kfishmidCLADE <- fishmidCLADE %>% 
  filter(Accuracy == max(Accuracy)) %>% # filter the data.frame to keep row where Accuracy is maximum
  select(k) # select column k
kfishmidCLADE <- kfishmidCLADE[1,]

set.seed(123)
predicted.classes_mid <- train(clades ~ X1a + X2a + X3a + X4a + X5a + X6a + X7a,
                               method     = "knn",
                               tuneGrid   = expand.grid(k = kfishmidCLADE),
                               trControl  = trainControl(method  = "LOOCV"),
                               metric     = "Accuracy",
                               data       = TrunkMid_sub)$pred # predict class based on KNN model
mean(predicted.classes_mid$pred == predicted.classes_mid$obs) #overall accuracy
...
t <-round(t, digits = 2)
write.table(t, file = "size corrected middelt trunk clade KNNAC", sep = ",", quote = FALSE, row.names = T)
...
runs <- 100
system.time({
  fishantCLADE <- foreach(icount(runs)) %dopar% {
    train(clades ~ X1a + X2a + X3a + X4a + X5a + X6a + X7a,
          method     = "knn",
          tuneGrid   = expand.grid(k = 1:17),
          trControl  = trainControl(method  = "LOOCV"),
...
predicted.classes_ant_clade <- train(clades ~ X1a + X2a + X3a + X4a + X5a + X6a + X7a,
                                     method     = "knn",
                                     tuneGrid   = expand.grid(k = kfishantCLADE),
                                     trControl  = trainControl(method  = "LOOCV"),
                                     metric     = "Accuracy",
                                     data       = TrunkAnt_sub)$pred # predict class based on KNN model
...
t <-round(t, digits = 2)
write.table(t, file = "size corrected anterior trunk clade KNNAC", sep = ",", quote = FALSE, row.names = T)
...
KnnAntPrediction <- knn(TrunkAnt_sub[,1:7], TrunkFossilAnt[,1:7],
                        TrunkAnt_sub$clades, k=kfishantCLADE , prob=TRUE)
KnnAntPrediction
t <- data.frame(fossil = TrunkFossilAnt$species, class = KnnAntPrediction)
...
t$V3<- as.numeric(t$V3)
t$V3 <- round(t$V3, 2)
write.table(t, file = "size corrected Anterior fossils.txt", sep = ",", quote = FALSE, row.names = T)


# MIDDLE FOSSILS #
KnnMidPrediction <- knn(TrunkMid_sub[,1:7], TrunkFossilT8[,1:7],
                        TrunkMid_sub$clades, k=kfishmidCLADE, prob=TRUE)
KnnMidPrediction
# t <- data.frame(fossil = TrunkFossilT8$species, class = KnnMidPrediction)
# 
...
t$V3<- as.numeric(t$V3)
t$V3 <- round(t$V3, 2)
write.table(t, file = "size corrected mid fossils.txt", sep = ",", quote = FALSE, row.names = T)


# POSTERIOR FOSSILS #
KnnPostPrediction <- knn(TrunkPost_sub[,1:7], TrunkFossilT12[,1:7],
                         TrunkPost_sub$clades, k=kfishpostCLADE, prob=TRUE)
KnnPostPrediction
# t <- data.frame(fossil = TrunkFossilT12$species, class = KnnPostPrediction)
# 
...
t$V3<- as.numeric(t$V3)
t$V3 <- round(t$V3, 2)
write.table(t, file = "size corrected posterior fossils.txt", sep = ",", quote = FALSE, row.names = T)


# SACRAL VERTEBRAE FOSSILS #
KnnSCPrediction <- knn(TrunkSc_sub[,1:7], TrunkFossilSc[,1:7],
                       TrunkSc_sub$clades, k=kfishScclade, prob=TRUE)
KnnSCPrediction
# t <- data.frame(fossil = TrunkFossilSc$species, class = KnnSCPrediction)
# 
...
t$V3<- as.numeric(t$V3)
t$V3 <- round(t$V3, 2)
write.table(t, file = "size corrected sacral fossils.txt", sep = ",", quote = FALSE, row.names = T)
...
t <- rf_acc_ant_clade
t <-round(t, digits = 2)
write.table(t, file = "size corrected Anterior verts RFAC clade", sep = ",", quote = FALSE, row.names = T)

mean(Atlas.rf_ant_clade$predicted == TrunkAnt_sub$clades) #overall accuracy

# FOSSIL CLASSIFICATION #
y_pred_ant_clade = predict(Atlas.rf_ant_clade, newdata = TrunkFossilAnt[,1:7],type="response")
y_pred_ant_clade
write.table(y_pred_ant_clade, file = "size corrected ant clade fossils RF.txt", sep = ",", quote = FALSE, row.names = T)
...
t <- rf_acc_mid_clade
t <-round(t, digits = 2)
write.table(t, file = "size corrected Middle verts RFAC clade", sep = ",", quote = FALSE, row.names = T)

mean(Atlas.rf_mid_clade$predicted == TrunkMid_sub$clades) #overall accuracy

# FOSSIL CLASSIFICATION #
y_pred_mid_clade = predict(Atlas.rf_mid_clade, newdata = TrunkFossilT8[,1:7],type="response")
y_pred_mid_clade
write.table(y_pred_mid_clade, file = "size corrected middle clade fossils RF.txt", sep = ",", quote = FALSE, row.names = T)
...
t <- rf_acc_post_clade
t <-round(t, digits = 2)
write.table(t, file = "size corrected Posterior verts RFAC clade", sep = ",", quote = FALSE, row.names = T)
...
y_pred_post_clade
write.table(y_pred_post_clade, file = "size corrected post clade fossils RF.txt", sep = ",", quote = FALSE, row.names = T)
...
t <- rf_acc_sc_clade
t <-round(t, digits = 2)
write.table(t, file = "size corrected Sacral verts RFAC clade", sep = ",", quote = FALSE, row.names = T)
